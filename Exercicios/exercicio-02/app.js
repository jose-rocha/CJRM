...
faça com que a obtenção da última letra funcione para qualquer palavra que
 a "randomWord" receber;
...
- Após a const "harryPotterAuthor" (abaixo), 
exiba no console a parte "J.K." da string "harryPotterAuthor";
- Não digite a string "J.K." manualmente;
*/

const harryPotterAuthor = 'J.K. Rowling';
// console.log(harryPotterAuthor[harryPotterAuthor.length - 12] + harryPotterAuthor[+ harryPotterAuthor.length - 11] + harryPotterAuthor[harryPotterAuthor.length - 10]  )
// console.log(harryPotterAuthor.slice(0, 4) )

/*
14 - Comente o console.log acima, e,

- Após a const "bestMovie" (abaixo), 
declare uma constante "realBestMovie";
...
- Utilize o operador addition assignment para atualizar o valor da let "episodes"
 para 10;
...
'O nº de episódios é: NUMERO_DE_EPISÓDIOS' em uma constante "allEpisodes";
...
- A template string deverá resultar no mesmo valor que a 
"newName" tinha anteriormente (nome e sobrenome com letras iniciais maiúsculas);
- Não digite a nova string manualmente.
- Não modifique a string da const "name";
- Exiba a "newName" no console;
*/
