...
const my3FavoriteTVShows = ['Two and Hal Man', 'Suits', 'The O.C']
...
// console.log(`Todos os ${falsyValues.length} itens do array ${falsyValues[2]} são falsy. Inclusive o  BOOLEAN`)
